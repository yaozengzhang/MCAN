...
class BuildGraph:
    ...
    def get_tfidf_vec(self):
        ...
        tfidf_vec = text_tfidf.fit_transform(open(self.content, "r", encoding='utf-8'))
...
def main():
    # BuildGraph("mr")
    BuildGraph("weibo_tvt_list_fold_1")
