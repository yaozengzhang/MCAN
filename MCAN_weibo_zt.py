...
"---------------------------------------------------------------------------------------------"
"文件位置"
folder_way = "F:\\原电脑深度学习相关\\谣言信息检测-博一工程\\WEIBO所有特征\\new_twitter_list"
...
folder_path = "F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/ALL_textimage"
text_features_wa = "F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/weibo_bert_sentence_embedding"
GCN_features_wa = "F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/GCN_weibotext_feature_tensor"
image_features_wa = "F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/Resnet50_feature_images_tensor"
ELA_features_wa = "F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/Resnet50_feature_ELA_images_tensor"
...
def set_up_data_loader(dataset_):
    ...
    with open("F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/weibo_tvt_list.txt",
              "r") as file:
...
def set_up_data_loader(dataset_):
    # Load the train-test information from tran_test.txt
    with open("F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/weibo_tvt_list.txt", "r") as file:
        lines = file.readlines()
    ...
    valid_indices = [i for i, label in enumerate(train_test_labels) if label == 'valid']
...
def main():
    for hyperparams in itertools.product(*hyperparameter_grid.values()):
        ...
        # 初始化一个新的 WandB 运行
        run_name = f"w_run_lr_{hyperparameter_dict['learning_rate']}_hs_{hyperparameter_dict['fusion_dim']}_nl_{hyperparameter_dict['cross_n_layers']}_nh_{hyperparameter_dict['cross_n_heads']}_dp_{hyperparameter_dict['dropout']}"
        print(run_name)
        wandb.init(project="MTAP_weibo_zt", entity="zhangyaozeng", name=run_name)
        ...
        cross_reference_file = 'F:/原电脑深度学习相关/谣言信息检测-博一工程/微博数据集所有特征/weibo_tvt_list.txt'
